...
public class ReentrantReadWriteLockUpgradeExample {
    ...
    public static void main(String[] args) {
        ReentrantReadWriteLockUpgradeExample reentrantReadWriteLockUpgradeExample = new ReentrantReadWriteLockUpgradeExample();
        reentrantReadWriteLockUpgradeExample.failedUpgradeAttempt();
    }
